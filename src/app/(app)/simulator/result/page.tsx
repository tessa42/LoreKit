  ...
  return (
    <>
      <div className="mx-auto max-w-2xl px-4 py-12">
        ...
        {/* 한 줄 설정 요약 */}
        <Card elevated className="mb-6 px-5 py-3">
        ...
        <Section label="시그니처 대사">
          <blockquote className="rounded-[var(--radius-md)] border-l-2 border-[var(--accent)] bg-[var(--accent-subtle)] px-5 py-4">
        ...
        {saveState === 'error' && (
          <div
            className="mt-4 rounded-[var(--radius-md)] border border-[var(--error-border)] bg-[var(--error-subtle)] px-4 py-3 text-sm text-[var(--error)]"
            role="alert"
          >
        ...
        <div className="mt-8 flex flex-wrap gap-3">
          <Link href="/simulator" className={buttonVariants({ variant: 'secondary', size: 'md' })}>
            다시 생성
          </Link>
          {saveState === 'saved' && (
